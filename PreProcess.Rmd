...
#' A function to  rasterize the zone-landuse-LUC data, and associate the leach rate with each zone-landuse-LUC combination to enable finding the average leach rate and area for each combination.
#'
#'This function generates a raster object of leach rates 
#'
