...
```
 By way of a check, it will be helpful to compare the total sub-management zone loads from the griddeed leachrate data with the total sub-management zone loads from the zone/landuse/LUC data.
 ...
 Then, as a check, get the load for each zone-landuse-LUC combination, and sum a in each zone
```{r}
