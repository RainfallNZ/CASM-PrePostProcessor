...
#save the map as an R file so that it can be used in an RShinyApp
saveRDS(map,file.path(ProjectDirectory,"R/CASM-PrePostProcessor/ShinyApp/Data","CASM-Network.RDS"))
```
