...
##Get the average leach rate for each polygon THIS TAKES ABOUT 42 MINUTES for 1km x 1km and 46 mins for 500 m x 500 m
tic()
...
DiffuseLeachRateData <- DiffuseLoadTableCreator(ZoneLanduseLUCPolygons = SubZoneLanduseLUCSpatial,LeachRates = LeachRate)
