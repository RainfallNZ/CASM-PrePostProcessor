...
names(DiffuseInputsSiteExtendedTable) <- c("Zone_Code","Landuse","LUC","Area(m2)","Land Area (ha)","Node Name","Original location (km)", "Receiving Stream", "Discharge Location (km)")
```
