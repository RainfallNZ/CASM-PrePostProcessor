...
REC_MeanFlowFile <- "REC2MeanFlow/REC2MeanFlow.RData"  #This is an RData file
...
IrrigableLandShapeFileName <- "IrrigableLandLayer"

IrrigatedLandShapeFileName <- "mfe-irrigated-land-area-2017-SHP"
...
load(file.path(GISDataDirectory, REC_MeanFlowFile))
