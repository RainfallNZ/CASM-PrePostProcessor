...
ScenarioLeachRateRaster <- function(CurrentLeachRateRaster = LeachRate, LUC_To_Leach_Table = LeachRateLimits, ZoneLanduseLUCRasterFile = ZoneLanduseLUCRasterFileName, ZoneLanduseLUCCode_To_ClassLUTFile = ZoneLanduseLUCCode_To_ClassLUTFileName, plan = "PC2", year = 20) {
  ...
  #Export a raster stock for exploration in QGIS
...
ZoneLanduseLUCCode_To_ClassLUTFileName <- "ZoneLanduseLUCCode_T_ClassLUT.csv"
...
#Save a copy for external use
writeOGR(SubZonePolygons,dsn = file.path(GISDataDirectory,"WaterManagementZonesForMapping"),"WaterManagementZonesForMapping",driver='ESRI Shapefile',overwrite_layer = TRUE)
